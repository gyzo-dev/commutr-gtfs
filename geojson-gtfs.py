...
geojson_file_path = 'TPUJ-4A-BP01.geojson'  # Assuming the file is in the same folder
...
with open('shapes.csv', 'w', newline='') as csvfile:
    ...
    if isinstance(geojson_data, dict) and 'geometry' in geojson_data:
        ...
        shape_id = "TPUJ-4A-BP01"  # Single route with ID JP101 (this will be constant for this route)
